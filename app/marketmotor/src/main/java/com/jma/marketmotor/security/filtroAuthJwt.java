...
public class FiltroAuthJwt extends OncePerRequestFilter {
    ...
    private static final Logger logger =  LoggerFactory.getLogger(FiltroAuthJwt.class);
    ...
    private String parseJwt(HttpServletRequest requests) {
        String jwt = jwtUtils.getJwtFromCookies(requests);
        return jwt;
    }
}
